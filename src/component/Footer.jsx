...
const Footer = () => {
  return (
    <>
      ...
      <footer className="bg-[#f0f3f4] dark:bg-gray-900  overflow-x-hidden">
          ...
          <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li className="mb-3">
                  <Link to="/deliverycharge" className="hover:underline">Delivery Charges</Link>
                </li>
                <li className="mb-3">
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-3">
                  <Link to="/howtoorder" className="hover:underline">How to Order?</Link>
                </li>
                <li className="mb-3">
